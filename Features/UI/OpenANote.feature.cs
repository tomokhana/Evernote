...
namespace Evernote.Features.UI
{
    ...
    [NUnit.Framework.DescriptionAttribute("OpenANote")]
    public partial class OpenANoteFeature
    {
...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/UI", "OpenANote", "As an SDET\r\nI want to test the functionality of opening a note\r\nSo that I can ver" +
                    "ify that the note is successfullt opened", ProgrammingLanguage.CSharp, ((string[])(null)));
...
#line hidden
#line 17
 testRunner.When("I open the latest note created", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
#line 18
